namespace Ogd.Virarium.Tests.Data
{
    ...
    [TestFixture]
    public class RepositoryTests : IRepositoryTests<IIdentifiable>
    {
        ...
        public void Test_GetAll_CollectionSet_ReturnsCollection()
        {
            ...
            var sut = new Repository<IIdentifiable>(Collection, NHibernateHelper);
        ...
        public void Test_Save_EntityGiven_VerifySessionSaveIsCalled()
        {
            ...
            var sut = new Repository<IIdentifiable>(null, NHibernateHelper);
        ...
        protected override IRepository<IIdentifiable> CreateIDaoImplementation()
        {
            var daoStub = new Repository<IIdentifiable>(Collection, NHibernateHelper);

            return daoStub;
        }

        protected override IRepository<IIdentifiable> CreateIDaoImplementation(ISessionFactory sessionFactory)
        {
            stubNHibernateHelper
                .Setup(x => x.SessionFactory)
                .Returns(() => sessionFactory);
            var daoStub = new Repository<IIdentifiable>(null, NHibernateHelper);
