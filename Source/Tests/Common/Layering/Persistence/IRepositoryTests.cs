namespace Ogd.Virarium.Tests.Common.Layering.Persistence
{
    using System;
    ...
    [TestFixture]
    public abstract class IRepositoryTests<T>
        where T : class, IIdentifiable
    {
        public static IQueryable<T> Collection { get; protected set; }

        protected abstract IRepository<T> CreateIDaoImplementation();

        protected abstract IRepository<T> CreateIDaoImplementation(ISessionFactory sessionFactory);
